...
function AddressSelect3({onSelectedGu, onSelectedDong, dong, gu}) {
    ...
    return (
    <div>
        <select id="gu3" value={selectedGu} onChange={handleGuChange}>
        ...
        <select id="dong3" value={selectedDong} onChange={handleDongChange} disabled={!selectedGu}>
