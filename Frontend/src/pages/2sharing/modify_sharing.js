    ...
    const foodTypes = {
      ...
      const onSubmit = (e) => {
        ...
        if (title.length === 0) {
          ...
          axios.put(`http://3.36.144.128:8080/api/sharing/${postId}`,form,{headers},data)
            .then(response => {
...
export default ModifyingSharing;